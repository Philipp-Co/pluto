...
bool PLUTO_SHLIB_Initialize(const char *path)
{
    ...
    *((void**)&PLUTO_SHLIB_library.setup) = dlsym(PLUTO_SHLIB_shared_lirary_handle, PLUTO_SHLIB_expected_symbols[0]);
    ...
    *((void**)&PLUTO_SHLIB_library.teardown) = dlsym(PLUTO_SHLIB_shared_lirary_handle, PLUTO_SHLIB_expected_symbols[1]);
    ...
    *((void**)&PLUTO_SHLIB_library.process) = dlsym(PLUTO_SHLIB_shared_lirary_handle, PLUTO_SHLIB_expected_symbols[2]);
